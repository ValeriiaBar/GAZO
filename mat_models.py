...
def CO_velocity(c: "концентрация", temp: "температура"):
    ...
    if c < 1e-10:
        ...
        w = pow(c, 0.69) * 600 * math.exp(-7600 / (1.987 * temp))
    return w


def AEU_velocity(c: "концентрация", temp: "температура", constants: 'sequence'):
...
def others_velocity(c: "концентрация", temp: "температура", constants: 'iterable'):
